...
----config----
local bot_api_key = "208182902:AAHbpRVU6j-Aqwwn78_gZcjQPI2iengoyYY" --Your telegram bot api key
...
elseif msg.chat.type == 'private' then
		...
		if msg.text:match("^/[sS]tart") then
			...
			local text = 'Hello {FIRSTNAME}!\nWelcome To My Pm Sender bot\nDeveloper : @Allwen'
			if mtn then
			text = mtn
			end
